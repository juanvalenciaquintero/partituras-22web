...
(function(){
  ...
  document.querySelector('#hamburguesa').addEventListener('click', (e) => {

        console.log(e.target);

        document.querySelector('#menuOculto').classList.toggle('oculto');

        document.querySelector('#menuOculto').classList.toggle('visible');
